...
this_path = Path(os.path.realpath(chengdu/chengdu201608.csv)).parent.parent / "rsrc" / "path_latlon"
...
def run():
    ...
    graph = ox.graph_from_place('Chengdu, China', network_type='all', simplify=False)
